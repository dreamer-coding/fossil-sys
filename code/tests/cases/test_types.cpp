...
FOSSIL_TEST_SUITE(cpp_types_suite);
...
FOSSIL_TEST_CASE(cpp_test_class_i8_subtraction) {
    fossil::sys::I8 a(20);
    fossil::sys::I8 b(10);
    fossil::sys::I8 result = a - b;
...
FOSSIL_TEST_CASE(cpp_test_class_u8_addition) {
    fossil::sys::U8 a(10);
    fossil::sys::U8 b(20);
...
FOSSIL_TEST_CASE(cpp_test_class_u8_subtraction) {
    fossil::sys::U8 a(20);
    fossil::sys::U8 b(10);
    fossil::sys::U8 result = a - b;
    ASSUME_ITS_TRUE(result.value == 10);
...
FOSSIL_TEST_CASE(cpp_test_class_i16_addition) {
...
FOSSIL_TEST_CASE(cpp_test_class_i16_subtraction) {
...
FOSSIL_TEST_CASE(cpp_test_class_u16_addition) {
...
FOSSIL_TEST_CASE(cpp_test_class_u16_subtraction) {
...
FOSSIL_TEST_CASE(cpp_test_class_i32_addition) {
...
FOSSIL_TEST_CASE(cpp_test_class_i32_subtraction) {
...
FOSSIL_TEST_CASE(cpp_test_class_u32_addition) {
...
FOSSIL_TEST_CASE(cpp_test_class_u32_subtraction) {
...
FOSSIL_TEST_CASE(cpp_test_class_i64_addition) {
...
FOSSIL_TEST_CASE(cpp_test_class_i64_subtraction) {
...
FOSSIL_TEST_CASE(cpp_test_class_u64_addition) {
...
FOSSIL_TEST_CASE(cpp_test_class_u64_subtraction) {
